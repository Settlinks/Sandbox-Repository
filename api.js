...
/* ── Security: API_URL and DRIVE_FOLDER_ID are XOR-obfuscated ─
   Neither value appears as a plain string in this source file.
   They are assembled in memory at runtime from integer arrays.

   ► HOW TO UPDATE THESE VALUES (e.g. if you redeploy the GAS):
       1. Open any page of the site in Chrome/Edge/Firefox.
       2. Press F12 → go to the "Console" tab (browser DevTools).
       3. Paste this and press Enter, replacing with your new value:
            Array.from("YOUR_NEW_VALUE").map((c,i)=>c.charCodeAt(0)^[79,83,82,69,72,65,66,50,48,50,53][i%11])
